...
ActiveRecord::Schema.define(version: 20180311144056) do
  ...
  create_table "voces", force: :cascade do |t|
    t.string "email"
    t.string "nombres"
    t.string "apellidos"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["concurso_id"], name: "index_voces_on_concurso_id"
  end

  add_foreign_key "voces", "concursos"
end
